...
public class Main {
    ...
    private static boolean usernameAvaible(String username) {
    ...
    private static void showRegisterMenu() {
        ...
        while (username.isEmpty() || usernameAvaible(username)) {
            if (username.isEmpty()) {
                System.out.println("Username Tidak Boleh Kosong");
            }

            if (usernameAvaible(username)) {
        ...
        while (!(gender.equalsIgnoreCase("Male") || gender.equalsIgnoreCase("Female"))) {
            System.out.println("Gender Hanya Ada Dua, male atau female");
            System.out.print("> ");
            gender = sc.nextLine();
        }
        /*
